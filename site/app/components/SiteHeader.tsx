...
export function SiteHeader({ current = "work" }: { current?: "work" | "about" }) {
  ...
  return (
    <header className={`site-header shell ${visible ? "header-visible" : "header-hidden"}`} onFocus={() => { focused.current = true; setVisible(true); }} onBlur={() => { focused.current = false; }}>
