...
export default function EnterpriseSearchCaseStudy() {
  return <main className="case-study">
    ...
    <CaseStudySection id="ai-attitudes" eyebrow="07 · AI attitudes" title="Three mindsets shaped adoption">
      <div className="persona-grid"><CaseStudyMedia kind="image" src={asset("ai-adversaries")} alt="Profile of employees who were adversarial toward AI" width={326} height={408} caption="Adversaries prioritized control, provenance, and reliability."/><CaseStudyMedia kind="image" src={asset("ai-light-users")} alt="Profile of light AI users" width={326} height={409} caption="Light users adopted AI selectively for low-risk acceleration."/><CaseStudyMedia kind="image" src={asset("ai-power-users")} alt="Profile of AI power users" width={327} height={409} caption="Power users expected synthesis, speed, and tool interoperability."/></div>
